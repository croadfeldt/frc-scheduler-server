# Scheduler eval — 20260513-223724-d7a7f1

Generated: 2026-05-14T03:37:24.320950+00:00
...
| repeat_opponents | ≤20 / ≤27 | ERROR | ✓ 12 |
...
| matchmaker | ✗ poor | 20.30 | 2.09s |  |

**Most-affected teams in matchmaker's best schedule**

| # | Team | Burden | Color | Station | Min gap | Partner rep | Opp rep | Day lops |
|---|---|---|---|---|---|---|---|---|
| 1 | 1816 | 3.83 | 2 | 1 | 7 | 0 | 1 | 2 |
| 2 | 2181 | 3.83 | 2 | 1 | 7 | 0 | 1 | 2 |
| 3 | 3278 | 2.83 | 3 | 0 | 7 | 0 | 1 | 1 |
| 4 | 2513 | 2.50 | 1 | 0 | 7 | 0 | 3 | 1 |
| 5 | 2855 | 2.50 | 2 | 1 | 7 | 0 | 0 | 0 |
...
|---|---|---|---|---|
| frc-scheduler-server | ERROR | — | — | ModuleNotFoundError: No module named 'ortools' |
| matchmaker | ✗ poor | 23.30 | 1.89s |  |

**Most-affected teams in matchmaker's best schedule**

| # | Team | Burden | Color | Station | Min gap | Partner rep | Opp rep | Day lops |
|---|---|---|---|---|---|---|---|---|
| 1 | 4511 | 4.33 | 2 | 1 | 6 | 1 | 2 | 0 |
| 2 | 8422 | 4.33 | 2 | 1 | 6 | 1 | 2 | 0 |
| 3 | 3197 | 4.00 | 0 | 1 | 6 | 0 | 3 | 2 |
| 4 | 6709 | 2.83 | 3 | 0 | 6 | 0 | 1 | 1 |
| 5 | 93 | 2.50 | 1 | 0 | 6 | 0 | 2 | 1 |
...
| repeat_partners | ≤0 / ≤2 | ERROR | ✓ 0 |
| max_partner_repeats | ≤1 / ≤2 | ERROR | ✓ 1 |
| repeat_opponents | ≤20 / ≤27 | ERROR | · 22 |
| max_opponent_repeats | ≤2 / ≤2 | ERROR | ✓ 2 |
| max_color_imbalance | ≤1 / ≤2 | ERROR | ✗ 3 |
| teams_with_5_2_color | ≤0 / ≤0 | ERROR | ✓ 0 |
| max_station_spread | ≤1 / ≤1 | ERROR | ✓ 1 |
...
| # | Team | Burden | Color | Station | Min gap | Partner rep | Opp rep | Day lops |
|---|---|---|---|---|---|---|---|---|
| 1 | 2855 | 4.00 | 3 | 0 | 5 | 0 | 3 | 1 |
| 2 | 2823 | 3.67 | 3 | 0 | 5 | 0 | 2 | 1 |
| 3 | 2472 | 3.50 | 2 | 1 | 5 | 0 | 3 | 0 |
| 4 | 3891 | 3.50 | 2 | 1 | 5 | 0 | 3 | 0 |
| 5 | 3630 | 3.33 | 3 | 0 | 5 | 0 | 1 | 1 |
