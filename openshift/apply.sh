...
echo "Applying manifests to namespace: frc-scheduler-server"
...
echo ""
echo "Done. Monitor build: oc start-build frc-scheduler-server-git --follow -n frc-scheduler-server"
